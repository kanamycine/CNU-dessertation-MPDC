//말단 파이프 길이
let terminalPipeLength = prompt("말단 지관의 파이프 길이는 ?");
//말단 노즐 갯수
...
// terminalNozzelNumber * waterQuantatyPerNozzel;
...
//손실수두는 생각하지 않고 우선 주관의 관경을 구하는 알고리즘을 산출 할 것.
//input값에 따라 동적으로 계산해 버리는 식을 세우세요
//먼저 예시를 통해서 값을 넣어보고 그 식에서 일반적인 규칙을 발견해내라 !
// 서언 재료방법 쓰세요.
